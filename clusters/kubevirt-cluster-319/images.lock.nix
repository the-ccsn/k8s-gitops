[
  ...
  }
  {
    ...
    imageDigest = "sha256:558420daf32bbc382e3e9af4537f4073085b336ddd47399a3b70e70087115978";
    finalImageName = "docker.io/bitnami/kubectl";
    finalImageTag = "latest";
    archiveHash = "sha256-PQzCHpprJu13BgBMsn3I2P6lC1uDKfzGEgcidEvVYhQ=";
    os = "linux";
    arch = "amd64";
    sources = [
  ...
  {
    imageName = "postgres";
    imageDigest = "sha256:57e5b9f69e672385cdf630f42b1306b5ca934c9bf8278b5f8b1948533d75a20b";
    finalImageName = "docker.io/library/postgres";
    finalImageTag = "15-alpine";
    archiveHash = "sha256-bQ5Vti/bKN+Q3SpkWG4JGdBKCYRDm44AVkMmgl6Fyg8=";
    os = "linux";
    arch = "amd64";
    sources = [
      { kind = "HelmRelease"; namespace = "prod"; name = "logto"; }
